    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-14 bg-black">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#86868B]">Continue your movie journey</p>
        </div>

        {error && (
          <div className="bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3 mb-5" data-testid="login-error">
        ...
        <p className="text-center mt-6 text-sm text-[#86868B]">
          ...
          <Link to="/register" className="text-[#0071E3] hover:underline font-medium" data-testid="register-link">
            Create one
          </Link>
        </p>
      </div>
